...
{
    if (empty($_POST['c_name']) || empty($_POST['res_name']) || $_POST['email'] == '' || $_POST['phone'] == '' || $_POST['url'] == '' || $_POST['o_hr'] == '' || $_POST['c_hr'] == '' || $_POST['o_days'] == '' || $_POST['address'] == ''||$_POST['latitude'] == ''||$_POST['longitude'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "update restaurant set c_id='$_POST[c_name]', title='$res_name',email='$_POST[email]',phone='$_POST[phone]',url='$_POST[url]',o_hr='$_POST[o_hr]',c_hr='$_POST[c_hr]',o_days='$_POST[o_days]',address='$_POST[address]',image='$fnew',latitude='$_POST[latitude]',longitude='$_POST[longitude]' where rs_id='$_GET[res_upd]' ";  // store the submited data ino the database :images												mysqli_query($db, $sql);
                mysqli_query($db, $sql);
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" name="latitude" class="form-control form-control-danger"
                                                   value="<?php echo $row['latitude']; ?>" placeholder="latitude">
                                        </div>
                                    </div>
                                    <!--/span-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" name="longitude" class="form-control form-control-danger"
                                                   value="<?php echo $row['longitude']; ?>" placeholder="longitude">
                                        </div>
                                    </div>
                                    <!--/span-->
