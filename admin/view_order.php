                            ...
                            <div class="table-responsive m-t-20">
                                <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="text-align: center;"><?php echo $rows['username']; ?></div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="text-align: center;"><?php echo $rows['title']; ?></div>
                                        </td>
                                        <td>
                                            <div style="text-align: center;">
                                                <a href="javascript:void(0);"
                                                   onClick="popUpWindow('user_profile.php?newform_id=<?php echo htmlentities($rows['o_id']); ?>');"
                                                   title="Update order">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="text-align: center;"><?php echo $rows['quantity']; ?></div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="text-align: center;">$<?php echo $rows['price']; ?></div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="text-align: center;"><?php echo $rows['address']; ?></div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="text-align: center;"><?php echo $rows['date']; ?></div>
                                        </td>
